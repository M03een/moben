...
class GlassContainer extends StatelessWidget {
  const GlassContainer(
      {super.key,
        ...
        required this.width,
        required this.child,  this.horizontalPadding, this.verticalPadding, this.borderRadius, this.virMargin, this.horMargin,} );
  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          margin: EdgeInsets.symmetric(vertical: virMargin ??0,horizontal: horMargin ??0),
